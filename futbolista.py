...
class Futbolista(Deportista):
    ...
    def __init__(self, nombre, edad, altura, sexo, anios, goles, tarjetas, piernaHabil): #pierna habil
        super().__init__(nombre, edad, altura, sexo, "Futbol", anios)
    ...
    def __str__(self):
        descripcion = "Mi nombre es {} soy profesional en el deporte {} Tengo {} años de edad y llevo {} años en el deporte".format(self.getNombre(), self.getDeporte(), str(self.getEdad()), str(self.getAñosPracticando()))
        return descripcion
